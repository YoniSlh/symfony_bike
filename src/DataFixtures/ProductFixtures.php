...
class ProductFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        $products = [
            ...
            ['name' => 'Overvolt AM 9.7 2024', 'image_id' => 2, 'type_ref' => 'type_2', 'price' => 5789.00, 'description' => 'VTT électrique puissant, parfait pour les aventures tout-terrain', 'stock' => 17, 'status' => ProductStatus::DISPONIBLE, 'poids' => 11.2, 'couleur' => 'Noir', 'marque' => 'Lapierre'],
